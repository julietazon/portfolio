...
// switch the theme based on the if the theme toggle is checked or not
...
// event listener to the theme toggle - switch the theme
...
function switchTheme(theme) {
  if (theme.target.checked) {
    ...
    // user's theme preference to light
    localStorage.setItem("theme", "light");
  } else {
    document.documentElement.setAttribute("data-theme", "dark");

    // user's theme preference to dark
...
if (currentTheme) {
  // body data-theme attribute match the local storage item
